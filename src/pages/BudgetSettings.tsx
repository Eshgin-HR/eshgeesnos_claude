    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="rounded-xl p-5 flex flex-col gap-4" style={{ backgroundColor: '#0d1f35', border: '1px solid #1a2a40' }}>
        ...
        <div className="flex flex-col gap-1.5">
          <label style={{ fontSize: '11px', color: '#6B7280' }}>Salary (AZN)</label>
          <div className="relative">
            <input
              ...
              style={inputStyle}
            />
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs" style={{ color: '#6B7280' }}>AZN/mo</span>
          </div>
          <p style={{ fontSize: '10px', color: '#6B7280' }}>Your net monthly salary or primary income source.</p>
        </div>
      </div>
      ...
      <div className="rounded-xl p-5 flex flex-col gap-4" style={{ backgroundColor: '#0d1f35', border: '1px solid #1a2a40' }}>
        ...
        <div className="flex flex-col gap-1.5">
          <label style={{ fontSize: '11px', color: '#6B7280' }}>Spending limit (AZN)</label>
          <div className="relative">
            <input
              type="number"
          ...
          <p style={{ fontSize: '10px', color: '#6B7280' }}>Maximum you want to spend this month.</p>
        </div>

        {/* Savings preview */}
        {Number(salary) > 0 && Number(limit) > 0 && (
          <div className="flex items-center justify-between rounded-lg px-3 py-2" style={{ backgroundColor: '#0A1628' }}>
            <span style={{ fontSize: '11px', color: '#6B7280' }}>Target monthly savings</span>
