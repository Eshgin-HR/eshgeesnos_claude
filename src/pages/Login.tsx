      ...
      <div className="w-full max-w-xs flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm mt-1" style={{ color: '#6B7280' }}>Personal Operating System</p>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col gap-2">
            <label style={{ fontSize: '11px', color: '#6B7280', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
              Password
            </label>
            <input
              type="password"
