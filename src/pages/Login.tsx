      ...
      <div className="w-full max-w-xs flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-3">
          <div
            ...
            style={{ backgroundColor: '#50CD89', color: '#ffffff' }}
          >
            E
          </div>
          <div className="text-center">
            <h1 className="text-2xl font-bold tracking-tight">EshgeenOS</h1>
            <p className="text-sm mt-1" style={{ color: '#6B6B7B' }}>Personal Operating System</p>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col gap-2">
            <label style={{ fontSize: '11px', color: '#6B6B7B', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
              Password
            </label>
            <input
              type="password"
              ...
              style={{
                ...
                border: `1px solid ${error ? '#ef4444' : '#E8E8F0'}`,
                fontSize: '14px',
              }}
            />
            {error && (
        ...
        <p style={{ fontSize: '10px', color: '#6B6B7B' }}>
