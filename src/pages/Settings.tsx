...
export default function Settings() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Manage section */}
      <div>
        <p className="font-bold uppercase tracking-widest mb-2 px-1" style={{ fontSize: '10px', color: '#787774', letterSpacing: '0.06em' }}>Manage</p>
      ...
      {/* Data section */}
      <div>
        <p className="font-bold uppercase tracking-widest mb-2 px-1" style={{ fontSize: '10px', color: '#787774', letterSpacing: '0.06em' }}>Data</p>
        <div className="rounded-xl overflow-hidden" style={{ backgroundColor: '#f7f7f5', border: '1px solid #e3e3e0' }}>
          <button
            onClick={exportData}
            className="w-full flex items-center gap-3 px-4 py-3 text-left hover:brightness-110 transition-all"
            style={{ borderBottom: '1px solid #e3e3e0' }}
          >
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p style={{ fontSize: '10px', color: '#787774', marginTop: '1px' }}>Clears all check-in history</p>
            </div>
          </button>
        </div>
      </div>
      ...
      <button
        ...
        style={{ backgroundColor: '#f7f7f5', border: '1px solid #e3e3e0', color: '#787774', fontSize: '13px' }}
      >
        Sign Out
      </button>
