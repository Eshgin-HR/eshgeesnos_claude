    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span style={{ fontSize: '11px', color: '#787774', minWidth: '100px', textAlign: 'center' }}>{weekLabel}</span>
          <button onClick={() => setWeekOffset(o => Math.min(o + 1, 0))} disabled={weekOffset === 0} className="p-1.5 rounded-lg disabled:opacity-30" style={{ backgroundColor: '#f7f7f5', color: '#787774' }}>
      ...
      <div className="rounded-xl p-4" style={{ backgroundColor: '#f7f7f5', border: '1px solid #e3e3e0' }}>
        <p className="font-bold uppercase tracking-widest mb-3" style={{ fontSize: '10px', color: '#787774', letterSpacing: '0.06em' }}>Habit Completion</p>
        <ResponsiveContainer width="100%" height={120}>
          <BarChart data={weekData} barCategoryGap="30%">
            ...
            <Tooltip contentStyle={{ backgroundColor: '#f7f7f5', border: '1px solid #e3e3e0', borderRadius: 8, fontSize: 11 }} itemStyle={{ color: '#fff' }} formatter={(v: number) => [`${v}%`, '']} />
      ...
      <div className="rounded-xl p-4 flex flex-col gap-3" style={{ backgroundColor: '#f7f7f5', border: '1px solid #e3e3e0' }}>
        <p className="font-bold uppercase tracking-widest" style={{ fontSize: '10px', color: '#787774', letterSpacing: '0.06em' }}>TapWork Hours</p>
      ...
      <div className="rounded-xl p-4 flex flex-col gap-4" style={{ backgroundColor: '#f7f7f5', border: '1px solid #e3e3e0' }}>
        <p className="font-bold uppercase tracking-widest" style={{ fontSize: '10px', color: '#787774', letterSpacing: '0.06em' }}>Review</p>
        {(['top_win', 'next_focus'] as const).map(key => (
          <div key={key} className="flex flex-col gap-2">
            <label style={{ fontSize: '12px', fontWeight: 500, color: '#37352f' }}>
      ...
      {/* 4-week trend */}
      <div className="rounded-xl p-4" style={{ backgroundColor: '#f7f7f5', border: '1px solid #e3e3e0' }}>
        <p className="font-bold uppercase tracking-widest mb-3" style={{ fontSize: '10px', color: '#787774', letterSpacing: '0.06em' }}>4-Week Momentum</p>
