  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="rounded-xl p-4" style={{ backgroundColor: '#0d1f35', border: '1px solid #1a2a40' }}>
        <p className="font-bold uppercase tracking-widest mb-3" style={{ fontSize: '10px', color: '#6B7280', letterSpacing: '0.06em' }}>30-Day Heatmap</p>
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          <div key={label} className="rounded-xl p-3 text-center" style={{ backgroundColor: '#0d1f35', border: '1px solid #1a2a40' }}>
            ...
            <p style={{ fontSize: '9px', color: '#6B7280', marginTop: '2px' }}>{label}</p>
          </div>
        ))}
      </div>
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-3">
                <div className="text-center">
                  ...
                  <p style={{ fontSize: '9px', color: '#6B7280' }}>current</p>
                </div>
                <div className="text-center">
                  <p className="font-bold" style={{ fontSize: '14px', color: '#EF9F27' }}>{bestStreak}</p>
                  <p style={{ fontSize: '9px', color: '#6B7280' }}>best</p>
                </div>
              </div>
            </div>
